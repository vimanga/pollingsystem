...
<body>
 <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
       ...
       <a class="navbar" href="Login.jsp">Log Out</a>
   ...
   <div class="mainBackground" >
    ...
    <body>
	<form id = "election" action = "ElectionRegister" font-size="15px" method="post">

	<div class = "container">
	<h1 >Add Elections</h1>
	
		<label><b>Election ID:</b></label>
		<input type="text" placeholder="Enter Election ID" name="E_Id" required>
	
		

		
		<label><b>Election Name:</b></label>
		<input type="text" placeholder="Enter Election Name" name="E_name" required>
		

		
		<label><b>Election Date:</b></label>
		<input type="text" placeholder="Enter Election Date" name="E_date" required>
       ...
       <div class="container">
           <div class="row">
               <div class="col-md-12 text-center">
                   <p style="padding-top: 1px;padding-bottom:5px">Online Voting &copy; Copyright 2018.</p>
               </div>
           </div>
       </div>
   </footer>
